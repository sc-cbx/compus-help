                ...
                <div className={HomePageCss.homepage}>
                        ...
                        <div className={HomePageCss.classification}>
                            ...
                            <div className={HomePageCss.allfication}>
                                ...
                                <Menu onClick={handleClick} mode="vertical" className={HomePageCss.fication} >
                                    ...
                                    <SubMenu  key="sub1" className={HomePageCss.submenutop} title={<span><img src={require("../imgs/19.png")} className={HomePageCss.fiicon}/><span className={HomePageCss.fispan}><Link to="/courier_helps" className={HomePageCss.link}>快递帮拿</Link></span></span>}>
                                        <Menu.Item key="3"><Link to="/courier_help">小</Link></Menu.Item>
                                        <Menu.Item key="4"><Link to="/courier_help">中</Link></Menu.Item>
                                        <Menu.Item key="5"><Link to="/courier_help">大</Link></Menu.Item>
                                    </SubMenu>
                                    <SubMenu key="sub2" className={HomePageCss.submenu} title={<span><img src={require("../imgs/20.png")} className={HomePageCss.fiicon}/><span className={HomePageCss.fispan}><Link to="/quick_food_purchase/foods" className={HomePageCss.link}>食品速购</Link></span></span>}>
                                        <Menu.Item key="6"><Link to="/quick_food_purchase/staplefood"><img src={require("../imgs/21.png")} className={HomePageCss.fiicon}/>主食</Link></Menu.Item>
                                        <Menu.Item key="7"><Link to="/quick_food_purchase/cookedfood"><img src={require("../imgs/22.png")} className={HomePageCss.fiicon}/>熟食</Link></Menu.Item>
                                        <Menu.Item key="8"><Link to="/quick_food_purchase/snacks"><img src={require("../imgs/23.png")} className={HomePageCss.fiicon}/>零食</Link></Menu.Item>
                                    </SubMenu>
                                    <SubMenu key="sub3" className={HomePageCss.submenu} title={<span><img src={require("../imgs/24.png")} className={HomePageCss.fiicon}/><span className={HomePageCss.fispan}><Link to="/online_buy_waters" className={HomePageCss.link}>网上购水</Link></span></span>}>
                                        <Menu.Item key="9"><Link to="/online_buy_water">1号公寓</Link></Menu.Item>
                                        <Menu.Item key="10"><Link to="/online_buy_water">2号公寓</Link></Menu.Item>
                                        <Menu.Item key="11"><Link to="/online_buy_water">3号公寓</Link></Menu.Item>
                                        <Menu.Item key="12"><Link to="/online_buy_water">4号公寓</Link></Menu.Item>
                                    </SubMenu>
                            ...
                            <div className={HomePageCss.carousel}>
                                <Carousel autoplay>
                                    <div>
                                        <Link to="/quick_food_purchase/foods"><img src={require("../imgs/t1.png")} className={HomePageCss.rotary}></img></Link>
                                    </div>
                                    <div>
                                        <Link to="/quick_food_purchase/foods"><img src={require("../imgs/t2.png")} className={HomePageCss.rotary}></img></Link>
                                    </div>
                                    <div>
                                        <Link to="/quick_food_purchase/foods"><img src={require("../imgs/t3.png")} className={HomePageCss.rotary}></img></Link>
                                    </div>
                                    <div>
                                        <Link to="/quick_food_purchase/foods"><img src={require("../imgs/t4.png")} className={HomePageCss.rotary}></img></Link>
                                    </div>
                                </Carousel>
                            </div>
                            {/* 登陆注册（个人中心） */}
                            ...
                            <div className={HomePageCss.food}>
                                <div className={HomePageCss.fh}>
                                    <div className={HomePageCss.more}>
                                        ...
                                        <a target="_blank" rel="noopener noreferrer" href ="/quick_food_purchase/foods" className={HomePageCss.lf}>查看更多>>></a> 
                                    </div>
