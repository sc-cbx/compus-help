...
import List_lift from './List_left';
// import Message_list from './Message_list/message_list';
import BindingPhone from './BindingPhone';
import AllOrder from './AllOrder';
import Address from './Address';
import ChangeHeadPhoto from './ChangeHeadPhoto';
import Information from './Information';
import News from './News';
// import MyWallet from './MyWallet';
import RealName from './RealName';
import RecyleOrder from './RecycleOrder';
import ReturnGood from './ReturnGood';
import SetPassword from './SetPassword';
import UserDelete from './UserDelete';
// import UserLocked from './UserLocked';
import WaitEvaluate from './WaitEvaluate';
import WaitGetGood from './WaitGetGood';
import WaitGiveMoney from './WaitGiveMoney';
